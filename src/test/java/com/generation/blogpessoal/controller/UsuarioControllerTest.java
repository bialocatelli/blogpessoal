...
public class UsuarioControllerTest {
	...
	public void listarUsuarioPeloId() {
		...
		Optional<Usuario> usuarioBusca = usuarioService.cadastrarUsuario(
				new Usuario(0L, "Jay Park", "jay_parka@email.com.br", "jay123", "https://i.imgur.com/EcJG8kB.jpg"));
	...
	public void deveAutenticarUsuario() {
		...
		usuarioService.cadastrarUsuario(
				new Usuario(0L, "Priscila P", "priscila_p@email.com.br", "123", "https://i.imgur.com/T12NIp9.jpg"));

		HttpEntity<UsuarioLogin> corpoRequisicao = new HttpEntity<UsuarioLogin>(
				new UsuarioLogin(0L, "", "priscila_p@email.com.br", "123", "", ""));
